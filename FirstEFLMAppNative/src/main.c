...
/*
static void
_button_clicked(Evas_Object *lb, Evas_Object *obj, void *event_info)
{
	dlog_print(DLOG_INFO, "Life_Cycle", "Click Event");
	elm_object_text_set(lb, "<align=center>Clicked</align>");
